...
class O3_CPU {
  public:
    ...
    //Arohan
    uint64_t num_of_instrs_kernel_mode,
             begin_num_of_instrs_kernel_mode,
             begin_num_of_instrs_user_mode,
             num_of_instrs_user_mode;
    //Arohan
	...
	operating_index = -1;
        ...
        //Arohan 
        num_of_instrs_kernel_mode=0;
        begin_num_of_instrs_kernel_mode=0;
        begin_num_of_instrs_user_mode=0;
        num_of_instrs_user_mode=0;
        //Arohan
